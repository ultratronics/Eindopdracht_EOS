...
proc create_root_design { parentCell } {
  ...
  # Create instance: ws2812b_0, and set properties
  set block_name ws2812b
  set block_cell_name ws2812b_0
  if { [catch {set ws2812b_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ws2812b_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net vhdlnoclk_0_clk65MHz [get_bd_pins vhdlnoclk_0/clk65MHz] [get_bd_pins ws2812b_0/clk]
  connect_bd_net -net ws2812b_0_dout [get_bd_ports dout_0] [get_bd_pins ws2812b_0/dout]
