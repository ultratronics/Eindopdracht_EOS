...
HD_PWD='D:/Vivado_Projecten/EindOpdracht1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WS2812.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WS2812.tcl -notrace
