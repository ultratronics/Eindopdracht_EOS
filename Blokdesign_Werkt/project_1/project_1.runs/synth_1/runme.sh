...
HD_PWD='D:/Vivado_Projecten/EindOpdracht1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WS2812.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WS2812.tcl
