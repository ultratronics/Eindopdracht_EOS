...
HD_PWD='c:/users/admin/documents/pxl/3dejaar/embedded_os/eindopdracht_eos/blokdesign_2/blokdesign.tmp/neomatrix_v1_0_project/NeoMatrix_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NeoMatrix_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NeoMatrix_v1_0.tcl
