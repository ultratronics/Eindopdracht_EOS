...
HD_PWD='c:/users/admin/documents/pxl/3dejaar/embedded_os/eindopdracht_eos/blokdesign_2/blokdesign.tmp/neomatrix_v1_0_project/NeoMatrix_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NeoMatrix_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NeoMatrix_v1_0.tcl -notrace
