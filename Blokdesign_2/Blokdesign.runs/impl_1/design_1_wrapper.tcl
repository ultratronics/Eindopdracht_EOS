...
set rc [catch {
  ...
  add_files -quiet C:/Users/admin/Documents/pxl/3dejaar/embedded_os/Eindopdracht_EOS/Blokdesign_2/Blokdesign.runs/synth_1/design_1_wrapper.dcp
...
set rc [catch {
  ...
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet D:/Vivado_Projecten/EindOpdracht1/Eindopdracht_EOS/Blokdesign_2/Blokdesign.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
