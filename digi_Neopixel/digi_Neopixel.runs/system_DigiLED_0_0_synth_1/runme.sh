...
HD_PWD='C:/Users/admin/Documents/pxl/3dejaar/embedded_os/Eindopdracht_EOS/digi_Neopixel/digi_Neopixel.runs/system_DigiLED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_DigiLED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_DigiLED_0_0.tcl
